...
- [x] The project includes these frontend-specific features:
  - [x] At least one redirection, where users are able to navigate to a new page with a new URL within the app
    > - Directory → individual artist page
  - [x] At least one interaction that the user can initiate and complete on the same page without navigating to a new page
    > - Follow/Unfollow, inline Post/Merch create/edit, Quick View
  - [x] Dynamic frontend routes created with React Router
  - [x] Hierarchically designed React components
    - [x] Components broken down into categories, including Page and Component types
      > - `pages/` vs `components/`
    - [x] Corresponding container components and presenter components as appropriate
      > - `ArtistDetail.jsx` composing `EditArtistProfileForm`, `CreatePostForm`, `CreateMerchForm`, `ArtistConcertsList`, `ArtistAbout`
...
- [x] The project includes a one-to-one database relationship
  > - `profile` and `admin`, both one-to-one with `artists`/`users`
...
- [x] The user can filter or sort items based on particular criteria as appropriate for your use case
  > - genre filter, merch type/price sort, concerts by city, artist search
- [x] Data is automatically generated in response to a certain event or user action. Examples include generating a default inventory for a new user starting a game or creating a starter set of tasks for a user creating a new task app account
  > - choosing "Artist" at signup automatically creates the artist row, profile row, and ownership link in one transaction; placing an order automatically creates the order and order_items records
- [x] Data submitted via a POST or PATCH request is validated before the database is updated (e.g. validating that an event is in the future before allowing a new event to be created)
  - [x] _To receive full credit, please be sure to demonstrate in your walkthrough that for certain inputs, the item will NOT be successfully created or updated._
    > - adding a concert with a past date, or an invalid ticket link, is rejected with a visible error message
...
- [x] Restrict available user options dynamically, such as restricting available purchases based on a user's currency
  > - cart quantity is capped to available merch stock
...
- [x] Disable buttons after they have been clicked
  - _At least 75% of buttons in your app must exhibit this behavior to receive full credit_
    > - place order, create post, create merch submit buttons, among others
- [x] Users can upload images to the app and have them be stored on a cloud service
  ...
  - _Selecting a photo from a list of provided photos does **NOT** count for this rubric item._
    > - using cloudinary for merch photos and user profile photo, both real file uploads, not urls
...
> ![Final Demo GIF 1](https://i.imgur.com/qFYIMVC.gif)
> ![Final Demo GIF 2](https://i.imgur.com/9V1XQqq.gif)

## Reflection

### 1. What went well during this unit?

> We successfully deployed the app to production, added a Spotify embed feature, manual concert creation, and finished seeding real, demo-ready content.

### 2. What were some challenges your group faced in this unit?

> Deployment surfaced a few issues that hadn't come up locally, especially around authentication. Working through them taught us a lot about how development and production environments can differ.

### 3. What were some of the highlights or achievements that you are most proud of in this project?

> Getting a real, working full-stack app fully deployed and live is the highlight — from database to authentication to a polished frontend, everything is connected and working end to end.

### 4. Reflecting on your web development journey so far, how have you grown since the beginning of the course?

> We've gone from basic CRUD in Milestone 3 to a full authentication system, real third-party API integrations, and a production deployment. This project pushed us to think beyond "does it work on my machine" to "does it work for real users."

### 5. Looking ahead, what are your goals related to web development, and what steps do you plan to take to achieve them?

> We're continuing to polish a few features, like Spotify account linking and a dedicated Artist Dashboard, and we're excited to keep building on what we've learned here in future projects.
